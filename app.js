...
if(document.body.dataset.page==='home'){
 ...
 let previewPromise;
 function startPreview(auto=false){return previewPromise??=(async()=>{const {mountAssemblyPreview}=await import('./preview.js');return mountAssemblyPreview($('assembly-film'),$('film-play'),$('film-phase'),{auto});})();}
